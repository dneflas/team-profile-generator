    ...
    .then(({ employeeType }) => {
        if (employeeType === 'Engineer') {
            ...
            .then(({ engineerName, engineerId, engineerEmail, engineerGithub }) => {
                this.engineer.push(new Engineer(engineerName, engineerId, engineerEmail, engineerGithub));
            ...
            .then(({ internName, internId, internEmail, internSchool }) => {
                this.intern.push(new Intern(internName, internId, internEmail, internSchool));
